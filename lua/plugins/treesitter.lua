...
return {
  {
    ...
    opts = {
      ensure_installed = {
        -- Core languages
        "bash", "c", "cpp", "css", "diff", "dockerfile", "lua", "luadoc", "luap", "vim", "vimdoc", "query",
        -- Web languages
        "html", "javascript", "jsdoc", "json", "jsonc", "scss", "graphql", "tsx", "typescript",
        -- GOTH stack
        "go", "gomod", "gosum", "gowork", "templ",
        -- Next.js stack
        "tsx", "typescript", "javascript", "jsx", "prisma", "regex", "markdown", "markdown_inline",
    ...
    config = function(_, opts)
      ...
      vim.treesitter.query.set("templ", "injections", [[
        ((attribute
          (attribute_name) @_attr_name
          (attribute_value) @injection.content)
         (#match? @_attr_name "^hx-.*$")
